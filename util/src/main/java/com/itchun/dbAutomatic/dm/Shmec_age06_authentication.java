...
public class Shmec_age06_authentication {
    ...
    protected static String java_path = root_path + "代码\\shmec_age06_authentication\\src\\main\\";
    protected static String java_home_prefix = "com/age06";
    ...
    protected static String java_service_path = java_home_path + "service/";
    protected static String java_service_impl_path = java_home_path + "service/impl/";
    protected static String sql_version_path = java_path + "resources/db_migration/";
    protected static String sql_db_name = "shmec_age06_authentication";
    ...
    protected static String[] sheetname_excluded = {"应用信息表(oauth_client)", "应用身份关联表(client_role)", "应用部门关联表(client_department)", "应用资料表(client_file)"};
    protected static String pagckage_root = java_home_prefix.replace("/", ".");
    ...
    protected static String package_service_prefix = "package " + pagckage_root + ".service;";
    protected static String package_service_impl_prefix = "package " + pagckage_root + ".service.impl;";
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < sheet_number; i++) {
            ...
            StringBuilder service_impl = new StringBuilder(package_service_impl_prefix + "\n\nimport " + pagckage_root + ".entity." + clazzName + ";\nimport " + pagckage_root + ".mapper." + mapperName + ";\n");
            service_impl.append("import " + pagckage_root + ".service.*;\n");
